...
public class CompareAndroidWithFigmaTest {
    ...
    private static final String[] PROVIDER_CLASSES = {
            "io.samples.appium.android.BajajFinservAndroidTest",
            "io.samples.appium.android.AppAutomationPlaygroundAndroidHomeTest",
            "io.samples.appium.android.AppAutomationPlaygroundAndroidPlannerScenarioTest",
    };
