...
public class BajajFinservWebTest {
    ...
    @Test
    void uatBusinessLoanTest() {
        String baselineImagePath = System.getProperty("user.dir") + File.separator + "downloaded_images"
                + File.separator + "desktop"
                + File.separator + "UAT.png";
        // Baseline.uploadImageAndSetAsBaseline(baselineImagePath, baselineName,
        // appName, testName, viewportSize);
        compareWithUploadedImage(baselineName,
                "https://www.bajajfinservmarkets.in/personal-loan");
    }

    // @Test
    void testBusinessLoanTest() {
        String baselineImagePath = System.getProperty("user.dir") + File.separator + "downloaded_images"
                + File.separator + "desktop"
                + File.separator + "PL-PDP-Template-Revamp-Desktop.png";
        // Baseline.uploadImageAndSetAsBaseline(baselineImagePath, baselineName,
        // appName, testName, viewportSize);
        compareWithUploadedImage(baselineName,
                "https://www.bajajfinservmarkets.in/personal-loan");
    ...
    private void compareWithUploadedImage(String baselineName, String url) {
        ...
        eyesSelenium.check("home",
                Target.region(By.xpath("/html/body/div/div/div[3]/div/div[4]/div/div/div[3]/div/div/div[2]")));
